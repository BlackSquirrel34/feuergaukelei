  ...
  return (
    ...
    <div className='flex items-center justify-center'>
        <div className="relative">
            ...
            <motion.span 
            className="absolute text-3xl top-2 left-0"
            initial={{ opacity: 0, scale: 0 }}
            animate={{ opacity: 1, scale: 1 }}
    ...
    <motion.h1
      ...
      >
        <span className="font-bold">Hello, I&apos;m Edith Förster.</span> I&apos;m a{" "}
        <span className="font-bold">Full-Stack developer</span> within my first year of experience. I enjoy
        building <span className="italic">sites & apps</span>. My focus is on the{" "}
      ...
      >
        <Link href="#contact"
          className="group bg-slate-900 text-white px-7 py-3 flex items-center gap-2 rounded-full 
          outline-none focus:scale-110 hover:scale-110 hover:bg-slate-950 active:scale-105 transition"
          onClick={() => {
        ...
        <a
          ...
          href="https://www.linkedin.com/in/foerster-cith/"
          target="_blank"
        >
          <BsLinkedin />
        </a>
        ...
        <a
          ...
          href="https://github.com/BlackSquirrel34/"
          target="_blank"
        >
          <FaGithubSquare />
        </a>
